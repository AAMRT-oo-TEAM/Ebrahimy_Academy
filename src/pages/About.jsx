...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-[#06070f] text-white font-IranianSans text-right">
      ...
      >
        <header className="absolute top-0 w-full bg-transparent shadow-lg text-center text-lg ">
          <div className="container mx-auto flex justify-between items-center p-5">
            <nav className="space-x-6">
              <a
                href="#about"
                className="text-gray-300 hover:text-yellow-400 transition p-2 font-IranianSans "
              >
                درباره 
              </a>
              <a
                href="#students"
                className="text-gray-300 hover:text-yellow-400 transition p-2"
              >
                شاگردان
              </a>
              <a
